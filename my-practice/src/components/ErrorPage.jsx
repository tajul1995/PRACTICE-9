...
const ErrorPage = () => {
  ...
  <div>
    ...
    <span className='text-2xl text-black'>Error:{error?error.message:'error occured'}</span>
    <span className='text-2xl text-black'>Error:{status?status:'no status found'}</span>
    <Link
            to='/'
